...
def tf_format_mnist_images(X, Y, Y_, n=100, lines=10):
    ...
    #tf.image.grayscale_to_rgb 灰度图转RGB
...
class MnistDataVis:
    ...
    def __init__(self, title1=None, title2=None, title3=None, title4=None, title5=None, title6=None, histogram4colornum=None, histogram5colornum=None, dpi=70):
        ...
        # TODO: finish exporting the style modifications into a stylesheet 完成将样式修改导出到样式表中
        ...
        def _init():
            ...
            ax1.set_ylim(0.975, 1)    # important: not autoscaled
            #ax1.autoscale(axis='y')
            ax2.set_ylim(0, 6)  # important: not autoscaled
